...
real_estate |>
  ...
  geom_point() +
  labs(x = "Distance from MRT (meters)", y = "House Price of Unit Area", y = "House Price of Unit Area", title = "MRT Distances to House Price per Unit Area" ) +
...
real_estate |>
    ...
    geom_point() +
  labs(x = "Distance from MRT (meters)", y = "House Price of Unit Area", title = "Randomly Sampled MRT Distances to House Price per Unit Area") +
  geom_smooth(method = "lm")
...
But just to be sure...lets calculate a p-value.
...
In all, it seems that proximity to MRT stations do play a significant role in Taiwan's house valuation. The original dataset's negative relationship is shown to be significantly different from the 1000 iterations of permutations tested with randomized data!
